...
/**
 * Returns the body associated with an asset if there is one
 * NUll otherwise
 * @return body or NULL
 */
...
/**
 * Returns the system associated with an asset if there is one
 * NUll otherwise
...
/**
 * Returns the text associated with an asset if there is one
 * NUll otherwise
 * @return text or NULL
 */
...
/**
 * Returns the SDL Rect associated with an asset
 * @return box
 */
