 ...
 * Acts like body_init_with_info() where info and info_freer are NULL and
 * direction is 0.
 */
 ...
 * @param direction angle in radians of the direction body is facing
...
/**
 * Gets the rotation speed of a body.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's angular velocity in inverse seconds
 */
double body_get_rotation_speed(body_t *body);

/**
 * Sets to rotation speed of a body.
 *
 * @param body a pointer to a body returned from body_init()
 * @param rotation_speed the rotation speed that is to be set for body rotation
 * speed
 */
...
/**
 * Returns the direction angle of a body from the starting direction
 *
 * @param body to get the direction angle from
 * @return angle in radians
 */
double body_get_direction_angle(body_t *body);
