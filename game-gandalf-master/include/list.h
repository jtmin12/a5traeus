...
/**
 * Adds an element to the list in a certain position. Shifting positions if
 * necessary
 *
 * @param list a pointer to a list returned from list_init()
 * @param value the element to add to the end of the list
...
/**
 * Sets the element in list at index to value and returns the previous element
 *
 * @param list list to set element in
 * @param value element to put in list at index
 * @param index spot to replace element at
 *
 * @return previous overwritten element at index
 */
