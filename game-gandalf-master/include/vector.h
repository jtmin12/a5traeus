...
/**
 * Turns an angle into a unit vector
 *
 * @param angle in radians that vector forms with standard axis
 * @returns a vector with length 1 and angle given by input
 */
vector_t create_unit_vector(double angle);

/**
 * Turns a scalar and an angle into a vector
 *
 * @param scalar magnitude of desired vector
 * @param angle in radians that vector forms with standard axis
 * @return vector with length scalar and angle of angle
 */
